...
colorLinea = [0.93 0.84 0.6]; % Color crema/dorado de la línea
colorMarcador = [0.4 0.6 0.8]; % Color azul del punto
...
% ==========================================
% 3. Tercera Gráfica: Espirógrafo (20 Anillos - CORREGIDO)
% ==========================================
subplot(1,3,3);
t3 = 0:0.005:2*pi;
